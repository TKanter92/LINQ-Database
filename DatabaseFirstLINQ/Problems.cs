...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemFour()
        {
            ...
            foreach (Product product in products)
            {
                if (product.Name.Contains("S") || product.Name.Contains("s"))
                {
                    Console.WriteLine(product.Name);
                }
            }
        ...
        private void ProblemFive()
        {
            ...
            foreach (User user in users)
            {
                if (user.RegistrationDate <= DateTime.Parse("12/31/2015"))
                {
                    Console.WriteLine(user.Email);
        ...
        private void ProblemSix()
        {
            ...
            foreach (User user in users)
            {
                if (user.RegistrationDate > DateTime.Parse("12/31/2016") && user.RegistrationDate < DateTime.Parse("01/01/2018"))
                {
                    Console.WriteLine(user.Email);
                    Console.WriteLine(user.RegistrationDate);
                }
        ...
        private void ProblemEight()
        {
            ...
            var productDetail = _context.ShoppingCarts.Include(pd => pd.Product).Where(pd => pd.User.Email == "afton@gmail.com");
            foreach (ShoppingCart shoppingCart in productDetail)
            {
                Console.WriteLine($"Product Name: {shoppingCart.Product.Name} Price: {shoppingCart.Product.Price}");
            }
        ...
        private void ProblemFourteen()
        {
            ...
            var newProduct = _context.Products.Where(p => p.Name == "Playstation 5").Select(p => p.Id).FirstOrDefault();
            var newUser = _context.Users.Where(n => n.Email == "david@gmail.com").Select(n => n.Id).SingleOrDefault();
        ...
        private void ProblemEighteen()
        {
            ...
            var userRole = _context.UserRoles.Include(ur => ur.User).Where(i => i.User.Email == "oda@gmail.com").SingleOrDefault();
